...
@Disabled
public class CF_Vuforia_Blue_Wheels_Jeff extends CF_Library implements SensorEventListener
{
   ColorSensor sensorRGB;
   OpenGLMatrix pose = null;

   final static int RedUpperLimit_LowRange = 20;
   final static int RedLowerLimit_LowRange = 0;
   final static int RedUpperLimit_highRange = 360;
   final static int RedLowerLimit_highRange = 325;
   final static int BlueUpperLimit = 270;
   final static int BlueLowerLimit = 220;
   ...
   private void strafeFromWall()
   {

   }


   private void aquireBlueWheels()
   {

   }


   private void driveToOffsetFromPicture()
   {
      int x;
      int y;
      int error;
   ...
   private void actuateButtonPusher()
   {

   }


   private void driveIntoBeacon()
   {
